...
public abstract interface Requests {
    ...
    kotlin.coroutines.Continuation<? super retrofit2.Response<com.example.newweatherapp.models.weather.WeatherResponse>> continuation);
    
    @org.jetbrains.annotations.Nullable()
    @retrofit2.http.GET(value = "forecast")
    public abstract java.lang.Object getSearchedCityForecast(@org.jetbrains.annotations.NotNull()
    @retrofit2.http.Query(value = "q")
    java.lang.String cityName, @org.jetbrains.annotations.NotNull()
    @retrofit2.http.Query(value = "units")
    java.lang.String units, @org.jetbrains.annotations.NotNull()
    kotlin.coroutines.Continuation<? super retrofit2.Response<com.example.newweatherapp.models.forecast.ForecastResponse>> continuation);
