...
object Constants {
    ...
    const val LOCATION_IMAGES_BASE_URL = "https://travel-advisor.p.rapidapi.com/locations/v2/"

    const val API_HOST = "community-open-weather-map.p.rapidapi.com"
    const val LOCATION_IMAGES_API_HOST="travel-advisor.p.rapidapi.com"

    const val API_KEY = "370f715c6cmsh2aedaf88c0ad5bcp1aafa4jsncf895a26cb42"
